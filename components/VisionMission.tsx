      ...
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-16 items-start">
          <div className="bg-gray-50 p-8 rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300">
            <h3 className="text-3xl font-bold text-gray-800 mb-4 border-b-4 border-firetech-red pb-2 inline-block">Our Vision</h3>
          ...
          <div className="bg-gray-50 p-8 rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300">
            <h3 className="text-3xl font-bold text-gray-800 mb-4 border-b-4 border-firetech-red pb-2 inline-block">Our Mission</h3>
            <p className="text-gray-600 leading-relaxed">
